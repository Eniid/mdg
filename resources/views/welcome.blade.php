...
<!-- Main Content -->
    ...
    <section class="main_sec presentation">
        <div class="pres_text">
            <h2 role="heading" aria-level="2">Le {{$lastEdition->edition_number}} marché des <span class="first_letter">Gourmets</span></h2>
    ...
    <section class="main_sec plus ">
        <h2 role="heading" aria-level="2" class="visually-hidden ">Les plus</h2>
    ...
    <section class="main_sec desc">
        <div class="exp annim">
            <h2 role="heading" aria-level="2"><span class="first_letter desc_title">Edition 2021</h2>

            <div class="this_edition_pres">
                {!!$lastEdition->presentation!!}
            </div>

            <a href="{{ asset('/about') }}" class="cta">En savoir plus sur nous<img src="" alt=""></a>
            <a href="{{ asset('/buy') }}" class="h_cta">Achetez vos tickets <img src="" alt=""></a>
        </div>
